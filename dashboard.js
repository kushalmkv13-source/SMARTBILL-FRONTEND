...
function initButtonInteractions() {
    ...
    const actionButtons = document.querySelectorAll(
        '.btn-action, .btn-new-invoice, .action-btn'
    );
    ...
    const newInvoiceBtn =
        document.querySelector('.btn-new-invoice');
...
const draft =
    Number(dashboard.draft_invoices || 0);
        ...
        Second preference:
        pending_invoices for compatibility.
        ...
        */
        ...
        if (
            dashboard.unpaid_invoices !== undefined &&
            dashboard.unpaid_invoices !== null
        ) {
...
function updateInvoiceChart(
    ...
    window.invoiceChart.data.labels = [
